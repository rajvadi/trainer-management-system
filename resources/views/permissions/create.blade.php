                ...
                <form action="{{ route('permissions.store') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               ...
                               id="name"
                               value="{{ old('name') }}"
                               placeholder="e.g. create trainers"
                    ...
                    <!-- <div class="rounded-2xl border border-indigo-100 bg-indigo-50 p-4">
                        <p class="text-sm font-semibold text-indigo-700">Naming suggestion</p>
                        <p class="mt-1 text-sm text-indigo-600">
                            Use lowercase with underscores, like <span class="font-semibold">view_logs</span> or <span class="font-semibold">delete_trainer</span>.
                        </p>
                    </div> -->
